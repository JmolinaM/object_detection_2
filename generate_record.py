...
csv_input_train= "objects_labels_train.csv"
csv_input_test = "objects_labels_evaluate.csv"
output_path_train = "train.record"
output_path_test = "test.record"
...
path = os.path.join(os.getcwd(), 'data/labelled')
...
writer.close()
print('Successfully created the TFRecords: {}'.format(output_path_train))
...
for group in grouped:
        ...
        writer.write(tf_example.SerializeToString())
writer.close()
print('Successfully created the TFRecords: {}'.format(output_path_test))
